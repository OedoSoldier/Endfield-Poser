...
- 下载：[Releases · v0.2.1](https://github.com/honxi1/Endfield-Poser/releases/tag/v0.2.1)
- 依赖全部自包含在 `deps/`，不依赖 EIEM 的构建产物（注入链路的思路参考 EIEM，AGPL-3.0）

## 下载与安装

从 [Releases](https://github.com/honxi1/Endfield-Poser/releases) 下载 `EndfieldPoser-v0.2.1.zip`，解压后按目录对应放置：
